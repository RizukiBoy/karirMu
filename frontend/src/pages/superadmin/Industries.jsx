...
export default function Industries() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name.trim()) {
      setError("Nama industri wajib diisi");
      return;
    }
    ...
    try {
      ...
      setError(err.response?.data?.message || "Gagal menambahkan industri");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    if (!confirm("Yakin ingin menghapus industri ini?")) return;
    ...
    try {
      ...
      alert("Gagal menghapus industri");
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            >
              <input
                type="text"
                placeholder="Masukkan Nama Industri Baru"
                value={name}
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between items-center mt-4 text-sm text-gray-600">
              <span>
                Menampilkan 1 - {industries.length} dari {industries.length} Industri
              </span>
