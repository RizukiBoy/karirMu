...
export default function SkillForm({ onSaved }) {
  ...
  const handleAdd = () => {
    if (!nameSkill.trim()) return alert("Nama skill wajib diisi");

    onSaved({
      name_skill: nameSkill.trim(),
      id: Date.now(), // id sementara untuk list lokal
    });
  ...
  return (
    <div className="border rounded-xl p-5 space-y-3">
      <h3 className="font-medium text-sm">Tambah Skill</h3>
