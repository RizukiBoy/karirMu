...
export default function WorkExperienceForm({ onSaved }) {
  const [form, setForm] = useState({
    company_name: "",
    job_title: "",
    start_date: "",
  ...
  // ⬅️ tambahkan "Tambah" dulu ke parent state
  const handleAdd = () => {
    ...
    onSaved({
      ...form,
      id: Date.now(), // sementara id lokal
    });
  ...
  return (
    <div className="border rounded-xl p-5 space-y-3">
      <h3 className="font-medium text-sm">Tambah Pengalaman Kerja</h3>
